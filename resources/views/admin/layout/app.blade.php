  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('adminassets') }}/assets/images/logo.png" alt="logo" /></a>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Penjaga Toko</p>
                </div>
              </a>
            ...
            <!-- <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Penjaga Toko</span>
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.perludicek') }}">Perlu Di Cek</a></li> --}}
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.perludikirim') }}">Pesanan Baru</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.dikirim') }}">Barang Di Kirim</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.selesai') }}">Barang Di Terima</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.dibatalkan') }}">Pesanan Dibatalkan</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item ">
    ...
    <script>
      ...
      var t = $('#table').DataTable({
          ...
          "order": [[ 1, 'asc' ]],
          "language" : {
              "sProcessing" : "Harap Tunggu Sebentar",
